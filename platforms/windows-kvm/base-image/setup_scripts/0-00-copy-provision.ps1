# Copy the provisioning scripts to the local disk as the very first thing we
# do. Anything that runs after a reboot (e.g. the Windows
...
Copy-Item -Recurse -Force -Path "$PSScriptRoot\..\setup_scripts" -Destination $provisionDir
